  ...
  return (
    <div className='flex flex-col w-[50px] md:w-[200px] lg:w-[320px] h-screen bg-sidebar left-0 sticky px-3 md:px-8 lg:px-12 py-5 md:pt-16 md:pb-5 z-10 '>
      ...
      <div className='text-putih flex flex-col space-y-5 h-full '>
        ...
        {isLoggedIn && (<div className='flex flex-row space-x-0 md:space-x-8 items-center  hover:text-button cursor-pointer'>
          <BiTask size={25} />
      ...
      <div className='text-putih flex flex-row space-x-0 md:space-x-8 items-center cursor-pointer'>
        <BiLogOut size={25} />
